...
<head>
    ...
    <link rel="stylesheet" href="CSS/charcuterie.css?v=<?php echo time(); ?>">
    ...
    <title>Venez découvrir toutes les charcuteries de La Cissonière</title>
</head>
...
<body>
        ...
        <div id="Nav_div">
            <nav class="hideOnPhone">
                <ul class="first_ul_navbar">
                    ...
                    <li class="container_links">
                        ...
                        <ul>
                            <li class="li_market">
                                <a href="charcuterie.php#charcuterie" class="link_charcuteries">Charcuterie</a>
                                <a href="charcuterie.php#charcuterie" class="icon_market_link"><img src="CSS/images/market-stall_modif.svg" class="market_icon" alt="icon market"></a>
                            </li>
                            <li class="li_market">
                                <a href="charcuterie.php#charcuterie_maison" class="link_charcuteries">Charcuterie
                                    Maison</a>
                                <a href="charcuterie.php#charcuterie_maison" class="icon_market_link"><img src="CSS/images/market-stall_modif.svg" class="market_icon" alt="icon market"></a>
                            </li>
                            <li class="li_market">
                                <a href="charcuterie.php#charcuterie_fraiche" class="link_charcuteries">Charcuterie
                                    Fraîche</a>
                                <a href="charcuterie.php#charcuterie_fraiche" class="icon_market_link"><img src="CSS/images/market-stall_modif.svg" class="market_icon" alt="icon market"></a>
                            </li>
                            <li class="li_market">
                                <a href="charcuterie.php#charcuterie_seche_maison" class="link_charcuteries">Charcuterie
                                    Sèche Maison</a>
                                <a href="charcuterie.php#charcuterie_seche_maison" class="icon_market_link"><img src="CSS/images/market-stall_modif.svg" class="market_icon" alt="icon market"></a>
                            </li>
                            <li>
                                <a href="charcuterie.php#traiteur" class="link_charcuteries">Traiteur</a>
                            </li>
                        </ul </li>
                    <li class="espacement_links">|</li>
                    <li class="container_links">
            ...
            <div id="div_sticky">
                ...
                <nav id="navbar_sticky_produits" class="hideOnPhone">
                    <ul>
                        <li class="container_links">
                            <a href="#charcuterie" class="produits_NextToIcon">Charcuterie</a>
                            <a href="#charcuterie" class="produits_icon"><img src="CSS/images/market-stall_modif_beige_produits.svg" alt="icon market beige">
                        <li class="espacement_links">|</li>
                        <li class="container_links">
                            <a href="#charcuterie_maison" class="produits_NextToIcon">Charcuterie Maison</a>
                            <a href="#charcuterie_maison" class="produits_icon"><img src="CSS/images/market-stall_modif_beige_produits.svg" alt="icon market beige"></a>
                        </li>
                        <li class="espacement_links">|</li>
                        <li class="container_links">
                            <a href="#charcuterie_fraiche" class="produits_NextToIcon">Charcuterie Fraîche</a>
                            <a href="#charcuterie_fraiche" class="produits_icon"><img src="CSS/images/market-stall_modif_beige_produits.svg" alt="icon market beige"></a>
                        </li>
                        <li class="espacement_links">|</li>
                        <li class="container_links">
                            <a href="#charcuterie_seche_maison" class="produits_NextToIcon">Charcuterie Sèche Maison</a>
                            <a href="#charcuterie_seche_maison" class="produits_icon"><img src="CSS/images/market-stall_modif_beige_produits.svg" alt="icon market beige"></a>
                        </li>
                        <li class="espacement_links">|</li>
                        <li class="container_links">
                            <a href="#traiteur" class="produits">Traiteur</a>
                        </li>
                    </ul>
                </nav>
            </div>
                    ...
                    <li>
                        <details>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#charcuterie" class="closeByLinks">Section Charcuterie &#10153;</a>
                                    <img src="CSS/images/market-stall_modif_beige.svg" class="market_icon" alt="icon market">
                                </li>
                                <li>
                                    <a href="#charcuterie_maison" class="closeByLinks">Section Charcuterie Maison &#10153;</a>
                                    <img src="CSS/images/market-stall_modif_beige.svg" class="market_icon" alt="icon market">
                                </li>
                                <li>
                                    <a href="#charcuterie_fraiche" class="closeByLinks">Section Charcuterie Fraîche &#10153;</a>
                                    <img src="CSS/images/market-stall_modif_beige.svg" class="market_icon" alt="icon market">
                                </li>
                                <li>
                                    <a href="#charcuterie_seche_maison" class="closeByLinks">Section Charcuterie Sèche Maison &#10153;</a>
                                    <img src="CSS/images/market-stall_modif_beige.svg" class="market_icon" alt="icon market">
                                </li>
                                <li>
                                    <a href="#traiteur" class="closeByLinks">Section Traiteur &#10153;</a>
                                </li>
                            </ul>
                        </details>
                    </li>
    ...
    <main>
        ...
        <section class="section" id="charcuterie">
            <div class="centre_edit">
                <?php
                $titre_charcuterieSup = array_filter($rows_texts, function ($text) {
                    return $text['name'] === 'titre_charcuterieSup';
                });
                $titre_charcuterieSup = reset($titre_charcuterieSup);

                if ($titre_charcuterieSup) :
                ?>
                    <h2><?php echo htmlspecialchars($titre_charcuterieSup['content']); ?></h2>
                    <?php else : ?>
                        <h2>Charcuterie</h2>
                    <?php endif; ?>
                    <div class="text-container editPage" data-text-id="titre_charcuterieSup">
                        <button class="add-text-form">Modifier le Titre</button>
                        <div class="form-area"></div>
                    </div>
            </div>
            <div class="container">
                <div class="item item1">
                    <div class="centre_edit">
                        <?php
                        $titre_Charcuterie1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Charcuterie1';
                        });
                        $titre_Charcuterie1 = reset($titre_Charcuterie1);

                        if ($titre_Charcuterie1) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Charcuterie1['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Charcuterie1">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Charcuterie1 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Charcuterie1';
                        });
                        $img_Charcuterie1 = reset($img_Charcuterie1);

                        if ($img_Charcuterie1) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Charcuterie1['filepath']). '?v=' . time(); ?>" alt="Image de viande de Charcuterie 1">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Charcuterie 1">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Charcuterie1">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Charcuterie1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Charcuterie1';
                        });
                        $para_Charcuterie1 = reset($para_Charcuterie1);

                        if ($para_Charcuterie1) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Charcuterie1['content']); ?></p>
                        <?php else : ?>
                        ...
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Charcuterie1">
                ...
                <div class="item item2">
                    <div class="centre_edit">
                        <?php
                        $titre_Charcuterie2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Charcuterie2';
                        });
                        $titre_Charcuterie2 = reset($titre_Charcuterie2);

                        if ($titre_Charcuterie2) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Charcuterie2['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Charcuterie2">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Charcuterie2 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Charcuterie2';
                        });
                        $img_Charcuterie2 = reset($img_Charcuterie2);

                        if ($img_Charcuterie2) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Charcuterie2['filepath']). '?v=' . time(); ?>" alt="Image de viande de Charcuterie 2">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Charcuterie 2">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Charcuterie2">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Charcuterie2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Charcuterie2';
                        });
                        $para_Charcuterie2 = reset($para_Charcuterie2);

                        if ($para_Charcuterie2) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Charcuterie2['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Charcuterie2">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
        ...
        <section class="section" id="charcuterie_maison">
            <div class="centre_edit">
                <?php
                $titre_charcuterieMaison = array_filter($rows_texts, function ($text) {
                    return $text['name'] === 'titre_charcuterieMaison';
                });
                $titre_charcuterieMaison = reset($titre_charcuterieMaison);

                if ($titre_charcuterieMaison) :
                ?>
                    <h2><?php echo htmlspecialchars($titre_charcuterieMaison['content']); ?></h2>
                    <?php else : ?>
                        <h2>Charcuterie Maison</h2>
                    <?php endif; ?>
                    <div class="text-container editPage" data-text-id="titre_charcuterieMaison">
                        <button class="add-text-form">Modifier le Titre</button>
                        <div class="form-area"></div>
                    </div>
            </div>
            <div class="container">
                <div class="item item1">
                    <div class="centre_edit">
                        <?php
                        $titre_Charcuterie_maison1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Charcuterie_maison1';
                        });
                        $titre_Charcuterie_maison1 = reset($titre_Charcuterie_maison1);

                        if ($titre_Charcuterie_maison1) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Charcuterie_maison1['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Charcuterie_maison1">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Charcuterie_maison1 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Charcuterie_maison1';
                        });
                        $img_Charcuterie_maison1 = reset($img_Charcuterie_maison1);

                        if ($img_Charcuterie_maison1) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Charcuterie_maison1['filepath']). '?v=' . time(); ?>" alt="Image de viande de Charcuterie_maison 1">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Charcuterie_maison 1">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Charcuterie_maison1">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Charcuterie_maison1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Charcuterie_maison1';
                        });
                        $para_Charcuterie_maison1 = reset($para_Charcuterie_maison1);

                        if ($para_Charcuterie_maison1) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Charcuterie_maison1['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Charcuterie_maison1">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                ...
                <div class="item item2">
                    <div class="centre_edit">
                        <?php
                        $titre_Charcuterie_maison2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Charcuterie_maison2';
                        });
                        $titre_Charcuterie_maison2 = reset($titre_Charcuterie_maison2);

                        if ($titre_Charcuterie_maison2) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Charcuterie_maison2['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Charcuterie_maison2">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Charcuterie_maison2 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Charcuterie_maison2';
                        });
                        $img_Charcuterie_maison2 = reset($img_Charcuterie_maison2);

                        if ($img_Charcuterie_maison2) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Charcuterie_maison2['filepath']). '?v=' . time(); ?>" alt="Image de viande de Charcuterie_maison 2">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Charcuterie_maison 2">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Charcuterie_maison2">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Charcuterie_maison2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Charcuterie_maison2';
                        });
                        $para_Charcuterie_maison2 = reset($para_Charcuterie_maison2);

                        if ($para_Charcuterie_maison2) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Charcuterie_maison2['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Charcuterie_maison2">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
        ...
        <section class="section" id="charcuterie_fraiche">
            <div class="centre_edit">
                <?php
                $titre_charcuterieFraiche = array_filter($rows_texts, function ($text) {
                    return $text['name'] === 'titre_charcuterieFraiche';
                });
                $titre_charcuterieFraiche = reset($titre_charcuterieFraiche);

                if ($titre_charcuterieFraiche) :
                ?>
                    <h2><?php echo htmlspecialchars($titre_charcuterieFraiche['content']); ?></h2>
                    <?php else : ?>
                        <h2>Charcuterie Fraîche</h2>
                    <?php endif; ?>
                    <div class="text-container editPage" data-text-id="titre_charcuterieFraiche">
                        <button class="add-text-form">Modifier le Titre</button>
                        <div class="form-area"></div>
                    </div>
            </div>
            <div class="container">
                <div class="item item1">
                    <div class="centre_edit">
                        <?php
                        $titre_Charcuterie_fraiche1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Charcuterie_fraiche1';
                        });
                        $titre_Charcuterie_fraiche1 = reset($titre_Charcuterie_fraiche1);

                        if ($titre_Charcuterie_fraiche1) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Charcuterie_fraiche1['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Charcuterie_fraiche1">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Charcuterie_fraiche1 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Charcuterie_fraiche1';
                        });
                        $img_Charcuterie_fraiche1 = reset($img_Charcuterie_fraiche1);

                        if ($img_Charcuterie_fraiche1) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Charcuterie_fraiche1['filepath']). '?v=' . time(); ?>" alt="Image de viande de Charcuterie_fraiche 1">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Charcuterie_fraiche 1">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Charcuterie_fraiche1">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Charcuterie_fraiche1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Charcuterie_fraiche1';
                        });
                        $para_Charcuterie_fraiche1 = reset($para_Charcuterie_fraiche1);

                        if ($para_Charcuterie_fraiche1) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Charcuterie_fraiche1['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Charcuterie_fraiche1">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                ...
                <div class="item item2">
                    <div class="centre_edit">
                        <?php
                        $titre_Charcuterie_fraiche2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Charcuterie_fraiche2';
                        });
                        $titre_Charcuterie_fraiche2 = reset($titre_Charcuterie_fraiche2);

                        if ($titre_Charcuterie_fraiche2) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Charcuterie_fraiche2['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Charcuterie_fraiche2">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Charcuterie_fraiche2 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Charcuterie_fraiche2';
                        });
                        $img_Charcuterie_fraiche2 = reset($img_Charcuterie_fraiche2);

                        if ($img_Charcuterie_fraiche2) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Charcuterie_fraiche2['filepath']). '?v=' . time(); ?>" alt="Image de viande de Charcuterie_fraiche 2">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Charcuterie_fraiche 2">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Charcuterie_fraiche2">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Charcuterie_fraiche2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Charcuterie_fraiche2';
                        });
                        $para_Charcuterie_fraiche2 = reset($para_Charcuterie_fraiche2);

                        if ($para_Charcuterie_fraiche2) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Charcuterie_fraiche2['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Charcuterie_fraiche2">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
        ...
        <section class="section" id="charcuterie_seche_maison">
            <div class="centre_edit">
                <?php
                $titre_charcuterie_seche_maison = array_filter($rows_texts, function ($text) {
                    return $text['name'] === 'titre_charcuterie_seche_maison';
                });
                $titre_charcuterie_seche_maison = reset($titre_charcuterie_seche_maison);

                if ($titre_charcuterie_seche_maison) :
                ?>
                    <h2><?php echo htmlspecialchars($titre_charcuterie_seche_maison['content']); ?></h2>
                    <?php else : ?>
                        <h2>Charcuterie Sèche Maison</h2>
                    <?php endif; ?>
                    <div class="text-container editPage" data-text-id="titre_charcuterie_seche_maison">
                        <button class="add-text-form">Modifier le Titre</button>
                        <div class="form-area"></div>
                    </div>
            </div>
            <div class="container">
                <div class="item item1">
                    <div class="centre_edit">
                        <?php
                        $titre_Charcuterie_seche_maison1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Charcuterie_seche_maison1';
                        });
                        $titre_Charcuterie_seche_maison1 = reset($titre_Charcuterie_seche_maison1);

                        if ($titre_Charcuterie_seche_maison1) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Charcuterie_seche_maison1['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Charcuterie_seche_maison1">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Charcuterie_seche_maison1 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Charcuterie_seche_maison1';
                        });
                        $img_Charcuterie_seche_maison1 = reset($img_Charcuterie_seche_maison1);

                        if ($img_Charcuterie_seche_maison1) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Charcuterie_seche_maison1['filepath']). '?v=' . time(); ?>" alt="Image de viande de Charcuterie_seche_maison 1">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Charcuterie_seche_maison 1">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Charcuterie_seche_maison1">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Charcuterie_seche_maison1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Charcuterie_seche_maison1';
                        });
                        $para_Charcuterie_seche_maison1 = reset($para_Charcuterie_seche_maison1);

                        if ($para_Charcuterie_seche_maison1) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Charcuterie_seche_maison1['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Charcuterie_seche_maison1">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                ...
                <div class="item item2">
                    <div class="centre_edit">
                        <?php
                        $titre_Charcuterie_seche_maison2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Charcuterie_seche_maison2';
                        });
                        $titre_Charcuterie_seche_maison2 = reset($titre_Charcuterie_seche_maison2);

                        if ($titre_Charcuterie_seche_maison2) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Charcuterie_seche_maison2['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Charcuterie_seche_maison2">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Charcuterie_seche_maison2 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Charcuterie_seche_maison2';
                        });
                        $img_Charcuterie_seche_maison2 = reset($img_Charcuterie_seche_maison2);

                        if ($img_Charcuterie_seche_maison2) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Charcuterie_seche_maison2['filepath']). '?v=' . time(); ?>" alt="Image de viande de Charcuterie_seche_maison 2">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Charcuterie_seche_maison 2">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Charcuterie_seche_maison2">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Charcuterie_seche_maison2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Charcuterie_seche_maison2';
                        });
                        $para_Charcuterie_seche_maison2 = reset($para_Charcuterie_seche_maison2);

                        if ($para_Charcuterie_seche_maison2) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Charcuterie_seche_maison2['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Charcuterie_seche_maison2">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
        ...
        <section class="section" id="traiteur">
            <div class="centre_edit">
                <?php
                $titre_traiteur = array_filter($rows_texts, function ($text) {
                    return $text['name'] === 'titre_traiteur';
                });
                $titre_traiteur = reset($titre_traiteur);

                if ($titre_traiteur) :
                ?>
                    <h2><?php echo htmlspecialchars($titre_traiteur['content']); ?></h2>
                    <?php else : ?>
                        <h2>Traiteur</h2>
                    <?php endif; ?>
                    <div class="text-container editPage" data-text-id="titre_traiteur">
                        <button class="add-text-form">Modifier le Titre</button>
                        <div class="form-area"></div>
                    </div>
            </div>
            <div class="container">
                <div class="item item1">
                    <div class="centre_edit">
                        <?php
                        $titre_Traiteur1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Traiteur1';
                        });
                        $titre_Traiteur1 = reset($titre_Traiteur1);

                        if ($titre_Traiteur1) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Traiteur1['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Traiteur1">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Traiteur1 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Traiteur1';
                        });
                        $img_Traiteur1 = reset($img_Traiteur1);

                        if ($img_Traiteur1) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Traiteur1['filepath']). '?v=' . time(); ?>" alt="Image de viande de Traiteur 1">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Traiteur 1">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Traiteur1">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Traiteur1 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Traiteur1';
                        });
                        $para_Traiteur1 = reset($para_Traiteur1);

                        if ($para_Traiteur1) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Traiteur1['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Traiteur1">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                ...
                <div class="item item2">
                    <div class="centre_edit">
                        <?php
                        $titre_Traiteur2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'titre_Traiteur2';
                        });
                        $titre_Traiteur2 = reset($titre_Traiteur2);

                        if ($titre_Traiteur2) :
                        ?>
                            <h3><?php echo htmlspecialchars($titre_Traiteur2['content']); ?></h3>
                        <?php else : ?>
                            <h3>Lorem ipsum dolor sit amet consectetur.</h3>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="titre_Traiteur2">
                            <button class="add-text-form">Modifier le Titre</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $img_Traiteur2 = array_filter($rows_images, function ($image) {
                            return $image['filename'] === 'img_Traiteur2';
                        });
                        $img_Traiteur2 = reset($img_Traiteur2);

                        if ($img_Traiteur2) :
                        ?>
                            <img src="<?php echo htmlspecialchars($img_Traiteur2['filepath']). '?v=' . time(); ?>" alt="Image de viande de Traiteur 2">
                        <?php else : ?>
                            <img src="CSS/images/qui_sommes_opti.jpg" alt="Image de viande de Traiteur 2">
                        <?php endif; ?>
                        <div class="image-container editPage" data-image-id="img_Traiteur2">
                            <button class="add-file-form">Modifier l'Image</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
                    <div class="centre_edit">
                        <?php
                        $para_Traiteur2 = array_filter($rows_texts, function ($text) {
                            return $text['name'] === 'para_Traiteur2';
                        });
                        $para_Traiteur2 = reset($para_Traiteur2);

                        if ($para_Traiteur2) :
                        ?>
                            <p><?php echo htmlspecialchars($para_Traiteur2['content']); ?></p>
                        <?php else : ?>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad itaque iste iure animi omnis
                                voluptate! Libero facere recusandae dolores vitae ducimus at fuga velit, nostrum numquam
                                voluptatibus quidem odit quod.</p>
                        <?php endif; ?>
                        <div class="text-container editPage" data-text-id="para_Traiteur2">
                            <button class="add-text-form">Modifier le Paragraphe</button>
                            <div class="form-area"></div>
                        </div>
                    </div>
