...
<head>
    ...
    <title>La Cissonière, connectez-vous à votre espace administrateur</title>
</head>
...
<body>
    ...
    <main>
        <section id="section_1">
            <h2>Vous êtes le propriétaire du site web ? Ou alors un des gérants ?</h2>
            <h2>Veuillez-vous connecter ci-dessous !</h2>
            <form id="loginForm" method="post" action="traitement_connexion">
                <div id="div_form">
                    <h3>Connexion</h3>
                    <div class="form-group">
                        <label for="email">Email*</label>
                            <input type="email" id="email" name="email" placeholder="Entrez votre Email..." value="<?php if (!empty($_SESSION['noResetEmail'])) {
                                                                                                                        echo $_SESSION['noResetEmail'];
                                                                                                                    } ?>" required>
                    </div>
