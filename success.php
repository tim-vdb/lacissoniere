...
<head>
    ...
    <title>La Cissonière, votre connexion a été réussie avec succès</title>
</head>
...
<body>
    ...
    <main>
        <h2 style="color:green;">Votre connexion a été réussie <?php echo $_COOKIE['username']; ?> !</h2>
        <a href="/">Revenir à la page d'accueil</a>
        <h3><a href="admins.php">Modifier les permissions/Identifiants des gérants du Site Web</a></h3>
    </main>
